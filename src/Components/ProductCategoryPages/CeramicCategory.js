...
class ModernCategory extends Component {
  ...
  handleChange = (searchTerm) => (event) => {
    ...
    if (this.state.searchTerm !== "") {
      const newlistProducts = this.props.ceramicList.filter((listProduct) => {
      ...
      this.setState({ searchResults: this.props.ceramicList });
    }
  };
                    ...
                    <div className="aa-product-inner">
                      ...
                      <div className="tab-pane  in active" id="men">
                        {this.state.searchTerm.length < 1
                          ? this.props.ceramicList.map((listProduct) => (
...
function mapStateToProps(state) {
  return {
    ceramicList: state.ProductReducer.ceramicList,
