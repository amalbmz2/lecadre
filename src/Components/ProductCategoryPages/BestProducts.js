...
import { getbestSales, getProduct,getProducts } from "../../Redux/Actions/ProductAction";
...
class BestProducts extends Component {
  ...
  handleChange = (searchTerm) => (event) => {
    ...
    if (this.state.searchTerm !== "") {
      const newlistProducts = this.props.listbestsales.filter((listProduct) => {
      ...
      this.setState({ searchResults: this.props.listbestsales });
    }
  };
                ...
                <ul className="seq-canvas">
                  <li className="seq-in">
                    <div className="seq-model">
                      <img data-seq src="assets/img/Capture.PNG" alt="" />
                    </div>
                    <div class="d-flex flex-column">
                      <div className="seq-title">
                        {/* <h2 data-seq>Meilleure collection</h2>
                      <p>Le meilleur site Web de vente des cadres</p>
                      <p>Achetez vos cadres à des prix imbattables ! </p> */}
                        <a
                          style={{
                            color: "black",
                  ...
                  <div className="row ">
                    ...
                    <div className="col-md-5 no-padding ">
                      <div className="aa-promo-left">
                        <div className="aa-promo-banner d-flex justify-content-center">
                          <img src="assets/img/Nouveautés.jpg" alt="Nouv" />
                    ...
                    <div className="col-md-5 no-padding">
                      <div className="aa-promo-left">
                        <div className="aa-promo-banner d-flex justify-content-center">
                          <img
                            src="assets/img/Meilleurevente.jpg"
                            alt="Meill"
                          />
                          <div className="aa-prom-content">
                            <h4
                            ...
                            >
                              <a href="/meilleurs">Meilleures ventes</a>
                            </h4>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="aa-product-area">
                    <div className="aa-product-inner">
                      ...
                      this.props.listproduct.favorisTag === false ? (
                        ...
                        >
                          <strong>{this.props.listproduct.productName}</strong>{" "}
                          a été ajouté dans votre favoris !!
                      ...
                      <div className="tab-pane  in active" id="men">
                        {this.state.searchTerm.length < 1
                          ? this.props.listbestsales.map((listProduct) => (
...
function mapStateToProps(state) {
  return {
    listbestsales: state.ProductReducer.listbestsales,
