...
class HomePage extends Component {
  ...
  handleChange = (searchTerm) => (event) => {
    ...
    if (this.state.searchTerm !== "") {
      const newlistProducts = this.props.listProducts.filter((listProduct) => {
      ...
      this.setState({ searchResults: this.props.listProducts });
    }
  };
                    ...
                    <div className="row">
                      <div className="col-md-4 col-sm-6">
                        <div className="aa-footer-widget ">
                          <h3 align="center" style={{ fontSize: "18px" }}>
                            Contact
                          </h3>
                          <table
                            align="center"
